...
div
  ...
  br
  template(v-for='{img, title, date, status, role} in events')
    a.event-card.has-text-dark
      .event-img
        img(:src='img')
      .event-content
        .event-content__inner
          .event-label {{title}}
          .event-date {{date}}
          .event-status.has-text-success {{role}}
</template>
...
export default {
  data() {
    return {
      events: [
        {
          img: "http://tnews.teenee.com/etc/img8/300699.jpg",
          title: "วิศณุ",
          date: "13 มีนาคม 2561",
          role: "ประธานค่าย",
          status: "approve"
        ...
        {
          img:
            "http://static.trueplookpanya.com/tppy/member/m_525000_527500/525016/cms/images/รับน้องก้าวใหม่ (15).png",
          title: "รับน้องก้าวใหม่",
          date: "13 มีนาคม 2561",
          role: "ทะเบียน",
          status: "approve"
        }
